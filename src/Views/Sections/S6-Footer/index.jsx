        ...
        <Container maxWidth="xl">
          <Grid style={{ background: '#0000004a', backdropFilter: 'blur(3px)', marginBottom: '60px', padding: '60px 20px' }}>
            <Grid container spacing={4} justifyContent="space-between">
              ...
              <Grid item xs={12} md={1.8}>
                ...
                <a href='https://app.aicm.store' style={{ textDecoration: 'none' }}><Link>Physical Products Store</Link></a>
                <a href='https://app.aicm.store' style={{ textDecoration: 'none' }}><Link>Virtual Products Store</Link></a>
                <a href='https://app.aicm.store' style={{ textDecoration: 'none' }}><Link>Virtual Services Store</Link></a>
              </Grid>
              ...
              <Grid item xs={12} md={1.5}>
                ...
                <a href="mailto:info@aicm.store" target='blank' style={{ textDecoration: 'none' }}>
          ...
          <Grid container spacing={2} justifyContent="space-between" sx={{ flexDirection: { xs: 'column-reverse', sm: 'row' }, alignItems: 'center', marginBottom: '30px' }}>
            <Grid item xs={12} sm={4} sx={{ textAlign: { xs: 'center', sm: 'left' }, marginLeft: { md: '30px' } }}>
              <Typography variant="body1">Copyright © 2025 AICM</Typography>
            </Grid>

            <Grid item xs={12} sm={4} sx={{ display: 'flex', justifyContent: 'end', flexDirection: { xs: 'column', sm: 'row' }, textAlign: 'center' }}>
